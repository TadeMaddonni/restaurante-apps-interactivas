...
const Location = () => {
  return (
    <section class="bg-[#EDE7D4]  pt-20 text-center ">

    {/* Titulo */}
    <h2 className="text-4xl px-6 md:py-12.5 lg:text-6xl text-[#191514]font-display font-medium text-left  mb-12 md:mb-0">
        Donde encontrarnos
    </h2>
